...
public class Magician extends Actor
{
    ...
    public Magician(GridDecorator grid, NextButton nextButton, BackCurtain backCurtain) {
    ...
    public void operateGrid() {
        ...
        if(!gridDecorator.isExpanded()) {
            ...
            world.addObject(message, 400, 130);
        ...
        System.out.println("is presseend " + nextButton.isPressed());
        Greenfoot.delay(100);
    }
    ...
    public Card trick(){
        ...
        System.out.println("fault at ZZZZ "+ faultRow +" "+faultColumn);
