...
public class GameProxy  
{
    ...
    {
        try {
                String service_url = "http://localhost:3001/restlet/addPlayer" ;
    ...
    {
        try {
                String service_url = "http://localhost:3001/restlet/getGameState" ;
                ClientResource afterPlayerAdd = new ClientResource( service_url ); 
    ...
    {
        try {
            String service_url = "http://localhost:3001/restlet/getGrid" ;
            ClientResource afterPlayerAdd = new ClientResource( service_url ); 
    ...
    {
        try {
            String service_url = "http://localhost:3001/restlet/submitScore" ;
            ClientResource afterPlayerAdd = new ClientResource( service_url ); 
    ...
    {
        try {
            String service_url = "http://localhost:3001/restlet/getScores" ;
            ClientResource afterPlayerAdd = new ClientResource( service_url ); 
