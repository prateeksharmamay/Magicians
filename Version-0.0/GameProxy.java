...
public class GameProxy  
{
    ...
    {
        try {
                String service_url = "http://localhost:8080/restlet/addPlayer" ;
    ...
    {
        try {
                String service_url = "http://localhost:8080/restlet/getGameState" ;
                ClientResource afterPlayerAdd = new ClientResource( service_url ); 
    ...
    {
        try {
            String service_url = "http://localhost:8080/restlet/getGrid" ;
            ClientResource afterPlayerAdd = new ClientResource( service_url ); 
     ...
     public void submitScore(String username, String score)
    {
        try {
            String service_url = "http://localhost:8080/restlet/submitScore" ;
            ClientResource afterPlayerAdd = new ClientResource( service_url ); 
    ...
    {
        try {
            String service_url = "http://localhost:8080/restlet/getScores" ;
            ClientResource afterPlayerAdd = new ClientResource( service_url ); 
