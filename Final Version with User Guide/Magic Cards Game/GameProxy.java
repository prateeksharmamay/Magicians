...
public class GameProxy implements IGameProxy 
{
    ...
    {
        try {
                String service_url = "http://35.162.206.200:8080/restlet/addPlayer" ;
    ...
    {
        try {
                String service_url = "http://35.162.206.200:8080/restlet/getGameState" ;
                ClientResource afterPlayerAdd = new ClientResource( service_url ); 
    ...
    {
        try {
            String service_url = "http://35.162.206.200:8080/restlet/getGrid" ;
            ClientResource afterPlayerAdd = new ClientResource( service_url ); 
    ...
    {
        try {
            String service_url = "http://35.162.206.200:8080/restlet/submitScore" ;
            ClientResource afterPlayerAdd = new ClientResource( service_url ); 
    ...
    {
        try {
            String service_url = "http://35.162.206.200:8080/restlet/getScores" ;
            ClientResource afterPlayerAdd = new ClientResource( service_url ); 
